...
// SimpleCam
#define COCOAPODS_POD_AVAILABLE_SimpleCam
#define COCOAPODS_VERSION_MAJOR_SimpleCam 0
#define COCOAPODS_VERSION_MINOR_SimpleCam 1
#define COCOAPODS_VERSION_PATCH_SimpleCam 0
